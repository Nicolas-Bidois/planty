    ...
    public function modal_form() {
                    ...
                    if ($this->dbdata['css'] != '') :
                        ?>
                                                    <button type="button" class="btn btn-secondary"
                                                            ...
                                                            id="oxi-addons-setting-rebuild">Rebuild
                                                    </button>
                <?php
            endif;
        ...
        ?>
                                            <button type="button" class="btn btn-danger"
                                                    id="oxi-addons-setting-reload">Reload
                                            </button>
                                            <input type="hidden" id="image-hover-preview-color"
                                                   name="image-hover-preview-color" value="<?php
        ...
        ?>">
                                            <input type="hidden" id="image-hover-style-id"
                                                   name="image-hover-style-id"
                                                   value="<?php echo (int) $this->dbdata['id']; ?>">
                                            <input type="hidden" id="image-hover-template"
                                                   name="image-hover-template"
                                                   value="<?php echo esc_attr(ucfirst($this->dbdata['style_name'])); ?>">
                                            <button type="button" class="btn btn-success"
                                                    id="oxi-addons-templates-submit">
                                                Save
                                            </button>
                                        </div>
                                    </div>
                                    ...
                                    <div class="oxi-addons-style-left-preview-heading">
                                        ...
                                        <div class="oxi-addons-style-left-preview-heading-right">
                                            <input type="text" data-format="rgb" data-opacity="TRUE"
                                                   ...
                                                   name="oxi-addons-2-0-color" value="<?php
                                if (is_array($this->style)) :
                                    if (array_key_exists('image-hover-preview-color', $this->style)) :
                                        echo esc_attr($this->style['image-hover-preview-color']);
                                    endif;
