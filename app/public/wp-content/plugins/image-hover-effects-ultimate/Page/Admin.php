    ...
    public function Render() {
        ...
        foreach ($Elements as $key => $elements) {
            ...
            foreach ($elements as $k => $value) {
                ...
                ?>
                        <div class="oxi-addons-shortcode-import" id="<?php echo esc_attr($value['name']); ?>"
                             oxi-addons-search="<?php echo esc_html($value['name']); ?>">
                            <a class="addons-pre-check" href="<?php echo esc_url(admin_url($oxilink)); ?>"
                               sub-type="<?php
