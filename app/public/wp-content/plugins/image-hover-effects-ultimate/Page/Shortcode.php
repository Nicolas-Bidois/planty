                ...
                <div class="modal-dialog modal-sm modal-dialog-centered">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <input class="form-control" type="file" name="importimagehoverultimatefile"
                        ...
                        <div class="modal-footer">
                            ...
                            <input type="submit" class="btn btn-success" name="importdatasubmit"
                                   id="importdatasubmit" value="Save">
                        </div>
                    </div>
                </div>
    ...
    public function created_shortcode() {
        ...
        <div class="oxi-addons-row">
            <div class="oxi-addons-row table-responsive abop" style="margin-bottom: 20px; opacity: 0; height: 0px">
                <table class="table table-hover widefat oxi_addons_table_data"
        ...
        foreach ($this->database_data() as $value) {
            ...
            ?>
                            <tr>
                                ...
                                <td><span>Shortcode &nbsp;&nbsp;<input type="text"
                                                                       onclick="this.setSelectionRange(0, this.value.length)"
                                                                       value="[iheu_ultimate_oxi id=&quot;<?php echo (int) $id ?>&quot;]"></span>
                                    <br>
                                    <span>Php Code &nbsp;&nbsp; <input type="text"
                                                                       onclick="this.setSelectionRange(0, this.value.length)"
                                                                       value="&lt;?php echo do_shortcode(&#039;[iheu_ultimate_oxi  id=&quot;<?php echo (int) $id ?>&quot;]&#039;); ?&gt;"></span>
                                </td>
                                <td>
                                    <a href="<?php echo esc_url(admin_url("admin.php?page=oxi-image-hover-ultimate&effects=$effects&styleid=$id")) ?>"
                                       title="Edit" class="btn btn-primary"
                                       style="float:left; margin-right: 5px;">Edit
                                    </a>
                                    <a href="#" title="Clone" class="btn btn-secondary oxi-addons-style-clone"
                                       datavalue="<?php echo (int) $id; ?>"
                                       style="float:left; margin-right: 5px;">Clone
                                    </a>
                                    <a href="<?php echo esc_url($this->get_export_link($id)); ?>"
                                       title="Export" class="btn btn-info"
                                       style="float:left; margin-right: 5px;">Export
                                    </a>

                                    <button class="btn btn-danger oxi-addons-style-delete" style="float:left"
                                            title="Delete" value="<?php echo (int) $id; ?>" type="button"
                                            value="delete">Delete
                                    </button>
                                </td>
                            </tr>
